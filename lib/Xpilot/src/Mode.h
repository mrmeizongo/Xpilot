...
public:
    ...
    virtual const Control::MODEPOS modePos(void) const = 0;   // Return mode switch position for this mode
...
public:
    ...
    const Control::MODEPOS modePos(void) const override { return Control::MODEPOS::LOW_POS; }
...
public:
    ...
    const Control::MODEPOS modePos(void) const override { return Control::MODEPOS::MID_POS; }
...
public:
    ...
    const Control::MODEPOS modePos(void) const override { return Control::MODEPOS::HIGH_POS; }
    void enter(void) override;
    void process(void) override;
    void run(void) override;
};
