...
static LowPassFilter<int16_t, SecondOrderLPF> rollLPF{PT_LPF_FREQ};
static LowPassFilter<int16_t, SecondOrderLPF> pitchLPF{PT_LPF_FREQ};
static LowPassFilter<int16_t, SecondOrderLPF> yawLPF{PT_LPF_FREQ};
