...
static LowPassFilter<int16_t> rollLPF{PT_LPF_FREQ, FilterType::FIRST_ORDER};
static LowPassFilter<int16_t> pitchLPF{PT_LPF_FREQ, FilterType::FIRST_ORDER};
static LowPassFilter<int16_t> yawLPF{PT_LPF_FREQ, FilterType::FIRST_ORDER};
